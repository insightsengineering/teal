...
* Added option to choose which variables can be filtered in the filter panel by using the `filterable` attributes of the lists of the `filter` argument of `init`. 
