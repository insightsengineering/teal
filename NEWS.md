...
* Add `teal.threshold_slider_vs_checkboxgroup)` as an option: If a categorical variable has more than this number of unique values, the filter panel use a drop-down select input instead of a checkbox group.
