...
* <span style="color: #3A88FE;">Teal Modules</span> (bar at the top): in this case a simple module named "example teal module".
...
See [this vignette](https://insightsengineering.github.io/teal/latest/articles/data-as-shiny-module.html) for details.
