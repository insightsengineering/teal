...
In practice, this means that some inputs might be initialized with `NULL` value, inadvertently triggering some observers.
Module developers have to be aware of this situation as often it will require `shiny::req` or `ignoreInit` argument in observers or `reactive` expressions.
