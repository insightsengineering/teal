...
If you need a refresher on the `teal_data` object, please visit the [teal.data package documentation](https://pharmaverse.github.io/teal.data/latest-tag/articles/teal-data.html).
...
3. **Return the data**: To allow for reporting capabilities we need to return the data. See [adding support for reporting vignette](adding-support-for-reporting.html)
...
The [`teal.widgets`](https://pharmaverse.github.io/teal.widgets/latest-tag/) package provides various widgets which can be leveraged to quickly create standard elements in your custom `teal` module.
