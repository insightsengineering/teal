...
app <- teal::init(
  data =  cdisc_data(
    cdisc_dataset("ADSL", ADSL, code = "radsl(cached = TRUE)"),
    cdisc_dataset("ADRS", ADRS, code = "radrs(cached = TRUE)"),
    cdisc_dataset("ADTTE", ADTTE, code ="radtte(cached = TRUE)")
  ),
...
[teal_git]: https://github.com/insightsengineering/teal "Teal GitHub Repository"
