...
app <- teal::init(
  data = cdisc_data(
    cdisc_dataset("ADSL", adsl, code = "synthetic_cdisc_data(\"latest\")$adsl"),
    cdisc_dataset("ADRS", adrs, code = "synthetic_cdisc_data(\"latest\")$adrs"),
    cdisc_dataset("ADTTE", adtte, code = "synthetic_cdisc_data(\"latest\")$adtte")
  ),
