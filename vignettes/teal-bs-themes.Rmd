...
Please, remember that custom themes are available only for bootstrap version 4 and 5.
...
Please, remember that only bootstrap 4 and 5 support custom themes, so we have to inject one of them to the teal::init app.
