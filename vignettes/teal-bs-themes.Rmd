...
Please apply a custom theme or run the interactive `themer` to explore all the theme options. In many scenarios updating the theme could not be enough and e.g. font color and other specifications have to be updated.
