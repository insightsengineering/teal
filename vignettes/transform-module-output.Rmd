...
Multiple decorators can be passed to `srv_transform_teal_data()`/`ui_transform_teal_data()` and they will be handled properly.
Remember that they should receive a list of `teal_transform_module`. 

```{r, eval=FALSE}
# in the module UI function
ui_transform_module("decorate", decorators)
