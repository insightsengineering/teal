...
For example, imagine you have a plot and you want to add a title.
A decorator function, like `add_title(x, "My Plot")`, takes an existing plot and updates it by adding a title while keeping everything else the same.
This makes it different from a function that creates a brand-new plot from scratch, as decorators work by enhancing what’s already there.
