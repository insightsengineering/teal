...
```{r}
library(ggplot2)
tm_decorated_plot <- function(label = "module",
                              decorator = list(plot_1 = teal_transform_module(), plot_2 = teal_transform_module())) {
...
app <- init(
  ...
  modules = modules(
    ...
    tm_decorated_plot(
      "interactive",
      decorator = list(plot_1 = interactive_decorator_1, plot_2 = interactive_decorator_2)
    )
  )
)
