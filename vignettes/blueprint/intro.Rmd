...
|[`teal.data`](https://github.com/insightsengineering/teal.data)           | provides the data structure used in all `teal` applications|
|[`teal.slice`](https://github.com/insightsengineering/teal.slice)         | provides the filter panel to allow dynamic filtering of data|
|[`teal.code`](https://github.com/insightsengineering/teal.code)           | provides a mechanism for tracking code to reproduce an analysis|
