...
1. Data is created and loaded into `teal` app;
    ...
    - The [`teal_data` class](teal_data.html) facilitates reproducibility;
...
3. Filtered data is sent to `teal` modules for analysis;
    - Each module receives a `teal_data` object so analysis code applied to the data is tracked _(and can be used for reproduce the whole analysis)_;
