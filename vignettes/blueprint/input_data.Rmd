...
The `teal.code` package provides the [`qenv` class](https://pharmaverse.github.io/teal.code/latest-tag/articles/qenv.html) that facilitates code reproducibility.
...
Learn more about the use of `teal_data` in the [`teal.data` package vignettes](https://pharmaverse.github.io/teal.data/latest-tag/articles).
...
![Show R Code](images/showrcode.png){width=60%}
...
![Reporter](images/reporter.png){width=100%}

To learn more about the `Reporter` feature, please visit the [`teal.reporter` documentation](https://pharmaverse.github.io/teal.reporter/latest-tag/index.html).
