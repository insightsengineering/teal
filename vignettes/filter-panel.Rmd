...
The technical details of the filter panel are extensively described in [`teal.slice` documentation](https://pharmaverse.github.io/teal.slice/latest-tag/).
...
For a detailed explanation about the filter states, see [this `teal.slice` vignette](https://pharmaverse.github.io/teal.slice/latest-tag/articles/filter-panel-for-developers.html).
