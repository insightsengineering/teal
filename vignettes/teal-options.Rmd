...
The path to the pre-computed `renv` `.lockfile` that will be shared through teal app. To read more about `.lockfile` usage creation check `?teal::create_renv_lockfile`.
