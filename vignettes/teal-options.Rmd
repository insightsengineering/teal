...
It allows customizing the R Markdown YAML arguments for the report. It should be a named vector and the names should be a subset of the suported YAML args: "author", "title", "date", "output", "toc".
