...
Note that this layout is formatted by the package `glue::glue`.
...
This option controls the bootstrap theme and version used in the teal apps. Achive better UX with the customized UI of an app.
Please visit the XXX vignette to read more about the functionality.
