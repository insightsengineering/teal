...
When writing decorators, one must follow the source code of the module in question.
...
3. The module functions, UI and server, take a list of decoratos as arguments and resolve them using `ui_transform_teal_data` and `srv_transform_teal_data`, respectively.
...
We can use the decorators defined above, applying each one to a separate instance of the same module.
