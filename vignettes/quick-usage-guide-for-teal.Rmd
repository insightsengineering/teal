...
* `teal_extend_server` adds custom server logic to the teal application, in this case the button created in the header is observed and a notification is shown.
