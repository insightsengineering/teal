...
* `modify_header` adds a header with a button that shows a notification when clicked, also note that the observer for this button was added using the modifier `add_custom_server`.
...
* `add_custom_server` adds custom server logic to the teal application, in this case the button created in the header is observed and a notification is shown.
...
app <- init(
  ...
  add_landing_popup(title = "Te al", content = "Welcome to my first teal application!") |>
