...
* `add_landing_popup` adds a landing popup that appears when the application is first loaded. Note app illustration below does not show the popup, but it will appear as soon as the application loads.
