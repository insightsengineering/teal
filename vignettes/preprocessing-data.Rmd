...
## Usage in `teal` apps
In this vignette, we will show how to use preprocessed data in `teal` apps. The basics of data preprocessing have been discussed in `teal.data` [here](https://insightsengineering.github.io/teal.data/main/articles/preprocessing-data.html).
