...
For a detailed explanation of join keys, see [this `teal.data` vignette](https://pharmaverse.github.io/teal.data/latest-tag/articles/join-keys.html).
...
For a detailed explanation of verification, see [this `teal.data` vignette](https://pharmaverse.github.io/teal.data/latest-tag/articles/teal-data-reproducibility.html).
...
For a complete guide to the `teal_data` class, please refer to the [`teal.data` package](https://pharmaverse.github.io/teal.data/latest-tag/).
