...
Note that since `data` was created by passing data objects, the code that was used to create the data objects is unknown so the process cannot be reproduced.
...
Keep in mind this code is not executed in the `teal_data`'s environment and so may not reproduce the environment.
