...
* <span style="color: #f2b73f;">Teal Modules</span> (tabs under the header): tab for each module included in the application. In this case two modules named "Module 1" and "Module 2".
* <span style="color: #83cc41;">Module Content</span> (panel on the middle): The outputs of currently active the module.
