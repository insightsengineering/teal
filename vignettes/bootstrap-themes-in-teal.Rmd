...
If, for some reason, you need to keep separately styled the parent app components and the teal components, use the option
```
options(
  "teal.ui.class" = "my-teal-class"
)
```
Which will add `my-teal-class` to the container of the teal modules to facilitate creation of css selectors only for the teal components.
