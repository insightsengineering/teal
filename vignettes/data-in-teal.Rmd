...
try(data_with_objects_and_code_verified <- teal.data::verify(data_with_objects_and_code)) # TODO uses `verify` function from main branch
try(data_with_objects_and_code_verified)
```
