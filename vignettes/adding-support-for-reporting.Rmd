...
If your module supports a report but you want to disable the show R code functionality, use `disable_src()`
...
One can set the template of the report, so that each card added to the report will contain template's content by default.
