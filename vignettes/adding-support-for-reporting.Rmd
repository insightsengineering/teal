...
app <- init(
  ...
  modules = c(
    modules(
      example_module(label = "1"),
      example_module(label = "2"),
      example_module(label = "3")
    ) |> disable_src(),
    modules(
      label = "Nested modules without sourc",
      example_module(label = "🗒️ Module 1"),
      example_module(label = "🗒️ Module 2")
    ) |> disable_src())
)
```
