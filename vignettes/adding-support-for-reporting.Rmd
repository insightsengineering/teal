...
To inform `teal` that the module requires reporting, return `reactive` containing `teal_report` from the `server` function.
Current outputs of the modules and a reproducible code will be included in the module when "add to report" button is clicked.
See below:
