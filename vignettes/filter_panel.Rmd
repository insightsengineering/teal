...
Any of filter-panel classes have a dedicated methods to set and get current filter state. These
methods include:
- `get_code`
- `get_data`
- `get_filter_state`
...
Above code can be also used in the module
    ...
    module(
      ...
      server = function(input, output, session, datasets) {
        ...
        observeEvent(input$add_species_filter, 
         datasets$set_filter_state(list(iris = list(Species = list(selected = c("setosa", "versicolor", "virginica")))))
        )
