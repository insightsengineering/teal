...
- [`teal.data::join_keys`](https://insightsengineering.github.io/teal.data/reference/join_keys.html) is a collection of multiple `teal.data::join_key` entries
- [`teal.data::join_key`](https://insightsengineering.github.io/teal.data/reference/join_key.html) specifies the relation between two datasets:
