...
#'   - \figure{yes.png} (`TRUE`) - filter is active in the module
#'   - \figure{no.png} (`FALSE`) - filter is inactive in the module
#'   - \figure{na.png} (`NA`) - filter is not available in the module
