...
get_dataset_prefixed_col_names <- function(data) {
  ...
  new_column_names <- paste(attr(data, "dataname"), non_key_columns, sep = ".")
...
prefix_col_names_with_dataset <- function(data) {
  overwrite_names <- get_dataset_prefixed_col_names(data)
