...
testthat::test_that("RelationalData with single dataset and connector", {
  ...
  testthat::expect_identical(get_raw_data(adtte), get_raw_data(items$ADTTE))
