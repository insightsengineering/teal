...
test_that("NamedDataset basics", {
  ...
  expect_silent({
    test_ds <- NamedDataset$new(x, name = "testds",
...
test_that("RelationalDataset basics", {
  ...
  expect_error(
    RelationalDataset$new(x = x, name = "abc")
  )

  expect_silent({
    test_ds <- RelationalDataset$new(x, name = "testds",
                                keys = list(primary = "x")
    )
  })
  ...
  expect_silent(test_ds$set_keys(list(primary = "y")))
  expect_equal(
    test_ds$keys,
    list(primary = "y")
  )
